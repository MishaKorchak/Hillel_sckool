...
if __name__ == "__main__":
    ...
    file1_path = r'C:\Mikhail_study_Hillel_school_python\Mikhail_study_Hillel_school_python\Hillel_sckool\homework6.3\homework_13\random.csv'
    file2_path = r'C:\Mikhail_study_Hillel_school_python\Mikhail_study_Hillel_school_python\Hillel_sckool\homework6.3\homework_13\random-michaels.csv'
    output_file = r'C:\Mikhail_study_Hillel_school_python\Mikhail_study_Hillel_school_python\Hillel_sckool\homework6.3\homework_13\result_mikhail.csv'

print(remove_duplicates(file1_path, file2_path, output_file))
